...
//		System.out.println("\t\t=======================================");
		// 原文
		String plaintext = "Wei@123.com";
		// plaintext = "123456";
		System.out.println("原始：" + plaintext);
		System.out.println("普通MD5后：" + MD5Utils2.getStrMD5(plaintext));

		// 获取加盐后的MD5值
		String ciphertext = MD5Utils2.getSaltMD5(plaintext);
		String ciphertext2 = MD5Utils2.getSaltMD5(plaintext);
		System.out.println("加盐后MD5：" + ciphertext);
		System.out.println("加盐后MD52：" + ciphertext2);
		System.out.println("是否是同一字符串:" + MD5Utils2.getSaltverifyMD5("wei123456", ciphertext2));
		/**
		 * 其中某次DingSai字符串的MD5值
		 */
...
//			System.out.println("是否是同一字符串:" + MD5Utils2.getSaltverifyMD5(plaintext, temp));
//		}
